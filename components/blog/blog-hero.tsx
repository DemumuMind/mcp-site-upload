...
export function BlogHero({ locale, copy }: BlogHeroProps) {
    ...
    return (<section className="rounded-3xl border border-violet-400/20 bg-indigo-950/72 p-6 sm:p-8">
      ...
      <p className="mt-4 max-w-3xl text-sm leading-7 text-violet-200 sm:text-base">{description}</p>
    </section>);
}
