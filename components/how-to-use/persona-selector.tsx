        ...
        {scenarios.map((scenario) => {
          ...
          return (
            <Card
              key={scenario.id}
              className={cn(
                "border-white/10 bg-slate-950/75 transition duration-300",
                isSelected
            ...
            >
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between gap-3">
                  <Badge
                    ...
                    className={cn(
                      ...
                      isSelected && "border-emerald-400/40 bg-emerald-500/10 text-emerald-200",
                    )}
                  >
                    {scenario.badge}
                  </Badge>
                ...
                <CardTitle className="text-xl text-slate-100">{scenario.title}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-sm leading-7 text-slate-300">{scenario.description}</p>
                <Button
                  type="button"
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "border-white/20 bg-slate-900/70 text-slate-100 hover:bg-slate-900",
                  )}
