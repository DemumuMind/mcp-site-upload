...
export function HeroSection({ content }: HeroSectionProps) {
  return (
    <section className="section-shell flex flex-col items-center gap-8 pb-16 pt-18 text-center sm:pb-20 sm:pt-24 lg:pt-28">
      ...
      <div className="mx-auto inline-flex max-w-full items-center gap-2 rounded-full border border-primary/35 bg-primary/10 px-4 py-2 text-xs text-foreground sm:text-sm shadow-[0_0_0_1px_rgba(247,201,72,0.16)]">
