...
export function BlogArticleCard({ post }: BlogArticleCardProps) {
  return (
    <Card data-anime-hover="card" className="group h-full border-slate-700/70 bg-slate-950/72 shadow-[0_0_0_1px_rgba(35,52,95,0.25),0_22px_64px_rgba(2,8,24,0.56)] transition duration-300 hover:-translate-y-0.5 hover:scale-[1.005] hover:border-primary/35">
