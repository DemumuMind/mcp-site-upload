    ...
    <DialogPrimitive.Overlay
      data-slot="dialog-overlay"
        className={cn(
          ...
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 duration-200 ease-out",
          className,
        )}
      {...props}
    />
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "gap-4 border border-border bg-card/90 p-6 shadow-2xl backdrop-blur-xl duration-200 ease-out motion-safe:will-change-transform rounded-2xl",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
