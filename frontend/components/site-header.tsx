    ...
    >
      ...
      >
        ...
        <div className="hidden items-center gap-1 lg:flex">
          ...
          <div className="ml-3 h-6 w-px bg-border/60" />
      ...
      {isMobileMenuOpen ? (
        <nav
          id="mobile-site-nav"
          className="border-t border-border/70 bg-background/98 px-4 py-3 supports-[backdrop-filter]:bg-background/94 sm:px-6 lg:hidden"
