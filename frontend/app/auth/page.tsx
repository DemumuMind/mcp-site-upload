...
export default async function AuthPage({ searchParams }: AuthPageProps) {
    ...
    return (<PageFrame variant="content">
      <PageShell className="max-w-5xl px-4 sm:px-6">
        <PageHero surface="plain" animated={false} badgeTone="violet" eyebrow={tr(locale, "Access", "Access")} title={tr(locale, "Sign in", "Sign in")} description={tr(locale, "Sign in to submit MCP servers and manage your account.", "Sign in to submit MCP servers and manage your account.")}/>
