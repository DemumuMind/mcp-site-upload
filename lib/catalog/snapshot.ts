...
function sortFacetEntries(entries: Array<[string, number]>): Array<[string, number]> {
...
function getLanguageEntries(servers: McpServer[]): Array<[string, number]> {
