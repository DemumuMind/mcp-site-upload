...
export default async function AuthResetPasswordPage() {
    ...
    return (<PageFrame variant="content">
      <PageShell className="max-w-5xl px-4 sm:px-6">
        <PageHero surface="plain" animated={false} badgeTone="violet" eyebrow={tr(locale, "Recovery", "Recovery")} title={tr(locale, "Reset password", "Reset password")} description={tr(locale, "Create a new password to regain access to your account.", "Create a new password to regain access to your account.")}/>
