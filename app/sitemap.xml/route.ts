...
const staticRoutes: readonly StaticSitemapRoute[] = [
  ...
  { path: "/vibeathon", changeFrequency: "weekly", priority: 0.7 },
  { path: "/vibeathon/leaderboard", changeFrequency: "daily", priority: 0.6 },
  { path: "/contact", changeFrequency: "monthly", priority: 0.6 },
  { path: "/jobs", changeFrequency: "weekly", priority: 0.6 },
  { path: "/ugc", changeFrequency: "weekly", priority: 0.6 },
  { path: "/ugc/brand-assets", changeFrequency: "monthly", priority: 0.5 },
  ...
  { path: "/faq/points", changeFrequency: "monthly", priority: 0.5 },
  { path: "/faq/streaks", changeFrequency: "monthly", priority: 0.5 },
